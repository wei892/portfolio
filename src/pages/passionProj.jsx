...
const PassionProj = () => {
  ...
  const embedInstaCode = `
    ...
    <a href="https://www.instagram.com/memoli.store/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank" rel="noreferrer"> 
      ...
      <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
        <a href="https://www.instagram.com/memoli.store/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;" target="_blank" rel="noreferrer">♡ 
          Memoli Store ♡ | Shop Open 💖</a> 
        (@<a href="https://www.instagram.com/memoli.store/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;" target="_blank" rel="noreferrer" >memoli.store</a>) • Instagram photos and videos
      </p>
    </div>
    </blockquote>
  `;
  ...
  return (
    <div>
      {/* this is going to showcasre my instagram profile */}
      <div className="artBuzCont">
        ...
        <div>
          ...
          include some images of my profile
        </div>
      </div>

      <div>
        {/* this will include my youtube channel */}
      </div>
      

      {/* this  will include my interests in graphic design*/}
      <div>
